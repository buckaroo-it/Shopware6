...
class EpsTest extends TestCase
{
    ...
    {
        $this->assertSame('eps', $this->payment->getBuckarooKey());
    }
    ...
    {
        $this->assertSame('EPS', $this->payment->getName());
    }

    public function testGetDescriptionReturnsCorrectText(): void
    {
        $this->assertSame('Pay with EPS', $this->payment->getDescription());
    }

    public function testGetPaymentHandlerReturnsCorrectHandler(): void
    {
        $this->assertSame(EpsPaymentHandler::class, $this->payment->getPaymentHandler());
    }

    public function testGetMediaReturnsPath(): void
    {
        $result = $this->payment->getMedia();
        $this->assertStringContainsString('eps.svg', $result);
    }
    ...
    {
        $this->assertSame('buckaroo_eps', $this->payment->getTechnicalName());
    }
