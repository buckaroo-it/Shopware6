...
class TransferTest extends TestCase
{
    ...
    {
        $this->assertSame('transfer', $this->payment->getBuckarooKey());
    }
    ...
    {
        $this->assertSame('Bank Transfer', $this->payment->getName());
    }

    public function testGetDescriptionReturnsCorrectText(): void
    {
        $this->assertSame('Pay with Bank Transfer', $this->payment->getDescription());
    }

    public function testGetPaymentHandlerReturnsCorrectHandler(): void
    {
        $this->assertSame(TransferPaymentHandler::class, $this->payment->getPaymentHandler());
    }

    public function testGetMediaReturnsPath(): void
    {
        $result = $this->payment->getMedia();
        $this->assertStringContainsString('sepa-credittransfer.svg', $result);
    }
    ...
    {
        $this->assertSame('buckaroo_transfer', $this->payment->getTechnicalName());
    }
