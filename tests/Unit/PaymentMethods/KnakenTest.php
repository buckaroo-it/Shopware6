...
class KnakenTest extends TestCase
{
    private Knaken $payment;

    protected function setUp(): void
    {
        $this->payment = new Knaken();
    }
    ...
    {
        $this->assertSame('knaken', $this->payment->getBuckarooKey());
    }
    ...
    {
        $this->assertSame('goSettle', $this->payment->getName());
    }

    public function testGetDescriptionReturnsCorrectText(): void
    {
        $this->assertSame('Pay with goSettle', $this->payment->getDescription());
    }

    public function testGetPaymentHandlerReturnsCorrectHandler(): void
    {
        $this->assertSame(KnakenPaymentHandler::class, $this->payment->getPaymentHandler());
    }

    public function testGetMediaReturnsPath(): void
    {
        $result = $this->payment->getMedia();
        $this->assertStringContainsString('gosettle.svg', $result);
    }
    ...
    {
        $this->assertSame('buckaroo_knaken', $this->payment->getTechnicalName());
    }
