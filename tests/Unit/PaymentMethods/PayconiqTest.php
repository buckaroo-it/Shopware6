...
class PayconiqTest extends TestCase
{
    ...
    {
        $this->assertSame('payconiq', $this->payment->getBuckarooKey());
    }
    ...
    {
        $this->assertSame('Payconiq', $this->payment->getName());
    }

    public function testGetDescriptionReturnsCorrectText(): void
    {
        $this->assertSame('Pay with Payconiq', $this->payment->getDescription());
    }

    public function testGetPaymentHandlerReturnsCorrectHandler(): void
    {
        $this->assertSame(PayconiqPaymentHandler::class, $this->payment->getPaymentHandler());
    }

    public function testGetMediaReturnsPath(): void
    {
        $result = $this->payment->getMedia();
        $this->assertStringContainsString('payconiq.svg', $result);
    }
    ...
    {
        $this->assertSame('buckaroo_payconiq', $this->payment->getTechnicalName());
    }
