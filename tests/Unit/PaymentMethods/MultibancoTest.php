...
{
    private Multibanco $payment;

    protected function setUp(): void
    {
        $this->payment = new Multibanco();
    }
    ...
    {
        $this->assertSame('multibanco', $this->payment->getBuckarooKey());
    }
    ...
    {
        $this->assertSame('Multibanco', $this->payment->getName());
    }

    public function testGetDescriptionReturnsCorrectText(): void
    {
        $this->assertSame('Pay with Multibanco', $this->payment->getDescription());
    }

    public function testGetPaymentHandlerReturnsCorrectHandler(): void
    {
        $this->assertSame(MultibancoPaymentHandler::class, $this->payment->getPaymentHandler());
    }

    public function testGetMediaReturnsPath(): void
    {
        $result = $this->payment->getMedia();
        $this->assertStringContainsString('multibanco.svg', $result);
    }
    ...
    {
        $this->assertSame('buckaroo_multibanco', $this->payment->getTechnicalName());
    }
