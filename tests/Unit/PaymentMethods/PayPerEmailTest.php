...
{
    private PayPerEmail $payment;

    protected function setUp(): void
    {
        $this->payment = new PayPerEmail();
    }
    ...
    {
        $this->assertSame('payperemail', $this->payment->getBuckarooKey());
    }
    ...
    {
        $this->assertSame('PayPerEmail', $this->payment->getName());
    }

    public function testGetDescriptionReturnsCorrectText(): void
    {
        $this->assertSame('Pay with PayPerEmail', $this->payment->getDescription());
    }

    public function testGetPaymentHandlerReturnsCorrectHandler(): void
    {
        $this->assertSame(PayPerEmailPaymentHandler::class, $this->payment->getPaymentHandler());
    }

    public function testGetMediaReturnsPath(): void
    {
        $result = $this->payment->getMedia();
        $this->assertStringContainsString('payperemail.svg', $result);
    }
    ...
    {
        $this->assertSame('buckaroo_payperemail', $this->payment->getTechnicalName());
    }
