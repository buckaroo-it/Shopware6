...
class KbcTest extends TestCase
{
    ...
    {
        $this->assertSame('KBCPaymentButton', $this->payment->getBuckarooKey());
    }
    ...
    {
        $this->assertSame('Kbc', $this->payment->getName());
    }

    public function testGetDescriptionReturnsCorrectText(): void
    {
        $this->assertSame('Pay with KBC', $this->payment->getDescription());
    }

    public function testGetPaymentHandlerReturnsCorrectHandler(): void
    {
        $this->assertSame(KbcPaymentHandler::class, $this->payment->getPaymentHandler());
    }

    public function testGetMediaReturnsPath(): void
    {
        $result = $this->payment->getMedia();
        $this->assertStringContainsString('kbc.svg', $result);
    }
    ...
    {
        $this->assertSame('buckaroo_KBCPaymentButton', $this->payment->getTechnicalName());
    }
