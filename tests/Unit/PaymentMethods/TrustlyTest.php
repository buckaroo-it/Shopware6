...
{
    private Trustly $payment;

    protected function setUp(): void
    {
        $this->payment = new Trustly();
    }
    ...
    {
        $this->assertSame('Trustly', $this->payment->getBuckarooKey());
    }
    ...
    {
        $this->assertSame('Trustly', $this->payment->getName());
    }

    public function testGetDescriptionReturnsCorrectText(): void
    {
        $this->assertSame('Pay with Trustly', $this->payment->getDescription());
    }

    public function testGetPaymentHandlerReturnsCorrectHandler(): void
    {
        $this->assertSame(TrustlyPaymentHandler::class, $this->payment->getPaymentHandler());
    }

    public function testGetMediaReturnsPath(): void
    {
        $result = $this->payment->getMedia();
        $this->assertStringContainsString('trustly.svg', $result);
    }
    ...
    {
        $this->assertSame('buckaroo_Trustly', $this->payment->getTechnicalName());
    }
