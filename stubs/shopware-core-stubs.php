...
namespace Shopware\Core\Checkout\Payment\Cart {
    if (!class_exists(AsyncPaymentTransactionStruct::class)) {
        class AsyncPaymentTransactionStruct {
            public function getOrderTransactionId(): string { return ''; }
            public function getReturnUrl(): string { return ''; }
            public function getOrder() { return null; }
            public function getOrderTransaction() { return null; }
        }
    }
...
namespace Shopware\Core\Checkout\Payment {
    if (!interface_exists(PaymentProcessor::class)) {
        interface PaymentProcessor {
            public function pay(string $orderId, \Symfony\Component\HttpFoundation\Request $request, \Shopware\Core\System\SalesChannel\SalesChannelContext $salesChannelContext, ?string $finishUrl = null, ?string $errorUrl = null): ?\Symfony\Component\HttpFoundation\RedirectResponse;
        }
    }
}
