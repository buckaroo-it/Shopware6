...
- Add PayPal Express sandbox environment support: new "Paypal express sandbox merchant id", "PayPalClientId (Test)" and "PayPalCollectingClientId (Test)" settings; credentials are now selected automatically based on the configured PayPal Test/Live mode.
