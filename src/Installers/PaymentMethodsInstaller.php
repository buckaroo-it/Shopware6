...
class PaymentMethodsInstaller implements InstallerInterface
{
    ...
    private function setDefaultValues()
    {
        ...
        foreach ([['pendingPaymentStatus'=>'open'],['paymentSuccesStatus'=>'paid'],['paymentFailedStatus'=>'cancelled'],['orderStatus'=>'open'],['klarnaBusiness'=>'B2C','klarnainBusiness'=>'B2C']] as $key => $value) {
