...
class PaypalPaymentHandlerModern extends PaymentHandler
{
...
if (\class_exists(\Shopware\Core\Checkout\Payment\Cart\PaymentHandler\AbstractPaymentHandler::class)) {
    \class_alias(PaypalPaymentHandlerModern::class, PaypalPaymentHandler::class);
} else {
    \class_alias(PaypalPaymentHandlerLegacy::class, PaypalPaymentHandler::class);
}
