...
/**
 * Modern payment handler strategy for newer Shopware versions
 */
class ModernPaymentHandlerStrategy implements PaymentHandlerStrategyInterface
{
    private PaymentHandlerModern $handler;

    public function __construct(PaymentHandlerModern $handler)
    {
